"""
Our specific script will target a user based on the information they leave publically
accessible via Twitter. Based on what it finds about locations, users, hashtags,
