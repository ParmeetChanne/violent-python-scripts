# Identifying hidden bluetooth radio on Apple Iphone.
# If you want to identify hidden bluetooth on different device, search for the OUI(Organizational Unique Identifier) for that device.
